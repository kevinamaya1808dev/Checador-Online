            ...
            <ion-icon name="close-outline"></ion-icon>
                ...
                <div class="mb-6">
                    <label class="flex items-center gap-2 text-xs font-bold tracking-widest text-gray-500 dark:text-gray-500 uppercase mb-4">
                        <ion-icon name="key-outline" class="text-gray-400 dark:text-gray-600"></ion-icon> Datos de acceso
                    </label>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-600">Modifica el usuario solo si es estrictamente necesario.</p>
                ...
                <div class="mb-6">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Cargo (Rol)</label>
                    <select name="role" id="edit_role" class="w-full px-4 py-2.5 bg-white dark:bg-white/[0.04] border border-[#EAE4D8] dark:border-white/10 rounded-lg text-gray-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-500/40 focus:border-blue-400 dark:focus:border-blue-500/60 transition-all">
...
</script><?php /**PATH C:\Users\tortu\Checador-Online\resources\views/admin/modals/editar-usuario.blade.php ENDPATH**/ ?>