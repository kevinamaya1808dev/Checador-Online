...
class EstadoTurnoPresenter
{
    ...
    private const INFO = [
        'inactivo'   => ['label' => 'Esperando turno', 'desc' => 'Aún no has registrado tu entrada.', 'texto' => 'text-slate-600 dark:text-slate-300', 'icon' => 'hourglass-outline'],
        'trabajando' => ['label' => 'Trabajando', 'desc' => 'Tu turno está activo.', 'texto' => 'text-green-700 dark:text-green-400', 'icon' => 'briefcase'],
        'pausado'    => ['label' => 'En pausa', 'desc' => 'Descanso en curso.', 'texto' => 'text-amber-700 dark:text-amber-400', 'icon' => 'cafe'],
        'terminado'  => ['label' => 'Turno finalizado', 'desc' => 'Registro guardado correctamente.', 'texto' => 'text-red-700 dark:text-red-400', 'icon' => 'flag'],
    ];
    ...
    public function __construct(?string $estadoRaw)
    {
        ...
        $this->info = self::INFO[$this->estado] ?? [
            'label' => ucfirst($this->estado), 'desc' => '', 'texto' => 'text-slate-600 dark:text-slate-300', 'icon' => 'help-circle-outline',
        ];
